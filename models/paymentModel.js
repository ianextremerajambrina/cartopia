...
const paymentSchema = mongoose.Schema(
  {
    ...
    cuotasTotales: { type: Number, default: null }, // Total de cuotas (e.g., 36 para 3 años)
    cuotaActual: { type: Number, default: null }, // Número de cuota actual (1, 2, ...)
    fechaProximaCuota: { type: Date, default: null }, // Fecha del próximo pago
    montoRestante: { type: Number, default: null }, // Dinero pendiente
    financiado: { type: Boolean, default: false }, // Flag para financiaciones
  },
  {
    timestamps: true,
  }
