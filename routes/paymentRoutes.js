...
// TODO P1.2: No debe crearse registro en rental si el coche se paga al completo de una vez (?). Los pagos recurrentes serán en payments (tipoPago = compra y transaccionRef = cars._id)
